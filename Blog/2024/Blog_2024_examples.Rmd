...
ggsave(ggplot(SST03.2017dt) +
  ...
  theme(
    ...
    coord_sf(xlim = c(xlim1+2,xlim2-2), 
             ylim = c(ylim1+2,ylim2-2))+ 
  scale_fill_viridis_c(option = "H"), 
       filename = paste0(here::here(),"/environmental_export.jpg"),
       width = 8, 
       height = 8, 
       units = "in",
       dpi = 300)
...
ggsave(ggplot() +
  ...
  coord_sf(xlim = c(-109.7,-109.1),ylim = c(24.6,25.2))+ 
  NULL,
       filename = paste0(here(),"/buffer_export.jpg"),
       width = 6, 
       height = 4, 
       units = "in",
       dpi = 300)
...
ggsave(Original_track+Interpolated_1m+Interpolated_15m,
       filename = paste0(here(),"/interpolate_export.jpg"),
       width = 10, 
       height = 4, 
       units = "in",
       dpi = 300)
...
ggsave(Plot_original+Plot_trips,
       filename = paste0(here(),"/identifytrip_export.jpg"),
       width = 9, 
       height = 4, 
       units = "in",
       dpi = 300)
...
ggsave(Plot_distance,
       filename = paste0(here(),"/points_export.jpg"),
       width = 6, 
       height = 10, 
       units = "in",
       dpi = 300)
